...
function Searchbar({ jobs, setSearchResults }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      return setSearchResults(state.jobs);
    } else {
      const resultsArray = state.jobs.filter((job) => {
        return (
      ...
      >
        ...
        <div className="w-full px-5 ">
          ...
          <button
            ...
            className="w-full hover:bg-light_primary  bg-primary text-white py-3 rounded-lg"
          >
            search
          </button>
        </div>
